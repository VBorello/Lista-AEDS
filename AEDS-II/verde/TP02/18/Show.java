...
public class Show{
    ...
    public static void quicksort(Show[] array, int esq, int dir, int[] comparacoes, int[] movimentacoes){
        ...
        while(i <= j){
            ...
            while(array[i].getTITLE().compareTo(pivo.getTITLE()) < 0){
                i++;
                comparacoes[0]++;
            }

            while(array[j].getTITLE().compareTo(pivo.getTITLE()) > 0){
        ...
        if(esq < j) quicksort(array, esq, j, comparacoes, movimentacoes);
        if(i < dir) quicksort(array, i, dir, comparacoes, movimentacoes);
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        quicksort(shows, 0, count - 1, comparacoes, movimentacoes);
        ...
        java.io.FileWriter log = new java.io.FileWriter("802305_quicksort.txt");
        
        log.write("802305\t" + comparacoes[0] + "\t" + movimentacoes[0] + "\t" + (fim - inicio) + "\n");
        log.close();
    }
}
