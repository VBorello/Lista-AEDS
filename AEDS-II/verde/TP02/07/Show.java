...
public class Show{
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i = 1; i < count; i++){
            ...
            while(j >= 0 && (shows[j].getTYPE().compareTo(key.getTYPE()) > 0 || 
                (shows[j].getTYPE().equals(key.getTYPE()) && shows[j].getTITLE().compareTo(key.getTITLE()) > 0))) {
        ...
        java.io.FileWriter log = new java.io.FileWriter("matricula_insercao.txt");
